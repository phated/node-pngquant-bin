...
var options = {
	...
	platform: {
		...
		win32: {
			bin: 'pngquant.exe',
			url: 'https://raw.github.com/sindresorhus/node-pngquant-bin/v0.1.5/vendor/win/x86/pngquant.exe',
			arch: {
				x64: {
					url: 'https://raw.github.com/sindresorhus/node-pngquant-bin/v0.1.5/vendor/win/x64/pngquant.exe',
				}
			}
		}
	}
